...
@implementation TVKGroupedTableTestController
	...
	-(void) addRow {
		...
		TVKTableViewContentCell *contentCell = [[TVKTableViewContentCell alloc] initWithContentViewClass:[TVKTableViewCellGradientContentView class] 
																								...
																								subtitle:@"Maximus Decimus Meridiaus is the ruler of the empire. Strength and honor you Roman hellots." 
																								   image:[UIImage imageNamed:@"TVKTableCatalog.png"]];
	...
	-(void) insertExpandableSection {
		...
		TVKTableItem *row = [[TVKTableItem alloc] initWithText:@"Settings" image:[UIImage imageNamed:@"Settings.png"]];
	...
	-(void) addSection {
		...
		row = [[TVKTableItem alloc] initWithText:@"Default Style With Image" image:[UIImage imageNamed:@"Settings.png"]];
		row.height = 44;
		[section addRow:row];
		[row release]; row = nil;
		...
		row = [[TVKTableItem alloc] initWithText:@"Value 1" labelText:@"Cell Style" image:[UIImage imageNamed:@"Settings.png"]];
		row.height = 44;
		[section addRow:row];
		[row release]; row = nil;
		...
		row = [[TVKTableItem alloc] initWithText:@"Value 2" captionText:@"Cell Style" image:[UIImage imageNamed:@"Settings.png"]];
		row.height = 44;
		[section addRow:row];
		[row release]; row = nil;
		...
		row = [[TVKTableItem alloc] initWithText:@"Subtitle" subtitleText:@"Title" image:[UIImage imageNamed:@"Camera.png"]];
		row.height = 44;
		[section addRow:row];
		[row release]; row = nil;

		row = [[TVKTableItem alloc] initWithText:@"Subtitle" subtitleText:@"Title" image:[UIImage imageNamed:@"TVKTableCatalog.png"]];
		row.height = 57;
		[section addRow:row];
		[row release]; row = nil;
...
//		[newRowButton release];
	...
	-(void) addRow {
		TVKTableGroup *rootSection = [self.tableController sectionWithName:@"Root"];
		TVKTableItem *row;
		row = [[TVKTableItem alloc] initWithCell:[[TVKTableViewContentCell alloc] initWithContentViewClass:[TVKTableViewCellGradientContentView class] 
